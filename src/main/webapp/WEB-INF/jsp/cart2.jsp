...
<head>
    ...
    <title>我的购物车</title>
    <link href="${pageContext.request.contextPath}/css/cart/index_1.css" type="text/css" rel="stylesheet" />
    <link href="${pageContext.request.contextPath}/css/cart/buy.css" type="text/css" rel="stylesheet" />
    <link href="${pageContext.request.contextPath}/css/cart/cart.css" type="text/css" rel="stylesheet" />
...
<div class="Header">
    <div class="ctr pr">
        <a href="/"><div class="Logo">
            <img src="${pageContext.request.contextPath}/picture/cart/logo_1.jpg" width="158" height="58" />
        </div></a>
...
<!--商品类目栏 end  --><div class="w">
    ...
    <div class="gray-box pro-li">
        <form id="payForm" action="#" method="post">
            ...
            <table width="40%" style="margin: auto;" border="0" align="center" cellpadding="0" cellspacing="0" class="clear list">
                ...
                <tr>
                    <td>收货人手机:</td>
                    <td><input type="text" name="userphone" id="userphone" value="${user.phone}"/></td>
                </tr>
                <tr>
                    <td>收货人地址:</td>
                    <td><input type="text" name="useraddress" id="useraddress" value="${user.address}"/></td>
                </tr>
                <tr>
                <td>支付方式:</td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <select name="sendWay">
                            <option value="1" selected="selected">天天快递</option>
            ...
            <table width="100%" style="margin: auto;" border="0" align="center" cellpadding="0" cellspacing="0" class="clear list">
    ...
    <div>
        <div class="fix_btm_bar clearfix">
            <div class="fr">
                ...
                <input type="button" id="confirmToPay" class="settlement" onclick="commitOrder2();" value="提交订单" />
        ...
        <ul class="tj_spul">
            <li>
                <a href="/sanxing/11.htm" target="_blank">
                    <img src="${pageContext.request.contextPath}/picture/cart/06161342epsy.jpg" width="132" height="132" />
                    <p>Meizu/魅族 MX6</p>
            ...
            <li>
                <a href="/Iphone/12.htm" target="_blank">
                    <img src="${pageContext.request.contextPath}/picture/cart/0616183833km.jpg" width="132" height="132" />
                    <p>小米手环2蓝牙</p>
                    <p style="text-align:left; color:#cc0000; font-size:20px;">
                        ¥100
                    </p>
            ...
            <li>
                <a href="/xj/13.htm" target="_blank">
                    <img src="${pageContext.request.contextPath}/picture/cart/06162301f2zj.jpg" width="132" height="132" />
                    <p>天猫魔盒3Pro</p>
                    <p style="text-align:left; color:#cc0000; font-size:20px;">
                        ¥100
                    </p>
            ...
            <li>
                <a href="/bjb/14.htm" target="_blank">
                    <img src="${pageContext.request.contextPath}/picture/cart/06162402vno3.jpg" width="132" height="132" />
                    <p>Asus/华硕 FX</p>
                    <p style="text-align:left; color:#cc0000; font-size:20px;">
                        ¥1000
                    </p>
            ...
            <li>
                <a href="/tsj/15.htm" target="_blank">
                    <img src="${pageContext.request.contextPath}/picture/cart/061625384z8h.jpg" width="132" height="132" />
                    <p>Edifier/漫步者</p>
                    <p style="text-align:left; color:#cc0000; font-size:20px;">
                        ¥100
                    </p>
            ...
            <li>
                <a href="/bg/16.htm" target="_blank">
                    <img src="${pageContext.request.contextPath}/picture/cart/061626478mo5.jpg" width="132" height="132" />
                    <p>虚拟现实3d眼镜</p>
                    <p style="text-align:left; color:#cc0000; font-size:20px;">
                        ¥100
                    </p>
...
<div class="Footer">
    ...
    <div class="Footer-block pt20 pb20 ctr cf">
        ...
        <div class="QR fl">
            <img class="QR-img" src="${pageContext.request.contextPath}/picture/cart/jspgou-wx.jpg" >
        </div>
    </div>
    <!-- 帮助中心栏目 end-->
...
<script type="text/javascript">
    function continueShopping() {
        ...
        function deleteFromCart(id){
            ...
            $.ajax({
                ...
                success:function (rec) {
                    if(rec=="0"){
                        location.href="${pageContext.request.contextPath}/cart/${user.id}";
                    }
                }
            })
        }
        ...
        function commitOrder2(){
            ...
            param = param+"&orderPrice="+$("#total").html();
