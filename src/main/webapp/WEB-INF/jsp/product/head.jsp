...
<title>	首页-CrazySuperManShop-</title>
...
<script src="js/product/jquery1.42.min.js" type="text/javascript"></script>
<script src="js/product/jquery.superslide.2.1.1.js" type="text/javascript"></script>
<link href="css/product/service.css" type="text/css" rel="stylesheet" />
</head>
    ...
    init: function () {
        ...
        for (var i = 0; i < _options.Accounts.length; i++) {
            ...
            if (srv.Type == "QQ") {
                ...
                html += "<li><a href='" + url + "' target='_blank'><img src='picture/product/bf4c0292cf3348b6b7ffe5b48178f019.gif" + srv.ID + ":1' border='0' alt='QQ' /></a></li>";
            }
            else if (srv.Type == "Ali") {
                var url = "http://amos.im.alisoft.com/msg.aw?v=2&uid=" + srv.ID + "&site=cntaobao&s=1&charset=utf-8";
                html += "<li><a href='" + url + "' target='_blank'><img border='0' src='picture/product/online.aw" + srv.ID + "&site=cntaobao&s=1&charset=utf-8' alt='在线客服'/></a></li>";
            }
        }
        html += "           </ul>";
        html += "       </div>";
        ...
        html += "   </div>";
        html += "   <div class='service-tips'><img src='picture/product/service-tips.png' alt='在线客服'></div>";
        html += "</div>";
        document.write(html);
	...
	<div class="Header">
		<div class="ctr pr">
			<a href=""><div class="Logo">
					<img src="picture/product/logo.jpg" width="158" height="58" />
				</div></a>
...
href="/ruishimingbiao/index.htm">瑞士名表</a></li>
			...
			<li class="Nav-item fl first active"><a href="${pageContext.request.contextPath}/" >首页</a></li>
...
src="picture/product/06160743kney.jpg" width="1624" height="440" /></a></li>
                   <li><a href="http://demo3.jeecms.com/fuzhuang/index.htm" target="_blank"><img 

src="picture/product/061607301kbo.jpg" width="1624" height="440" /></a></li>
                   <li><a href="http://demo3.jeecms.com/riyongbaihuo/index.htm" target="_blank"><img 

src="picture/product/06160703u2s5.jpg" width="1624" height="440" /></a></li>
	...
	<div class="advert-img">
		<div class="w clearfix">
			...
			<div class="fl img-item last">
				...
				<img src="picture/product/s1.jpg"></a>
...
<script type="text/javascript">
$(function(){
	var caseHtml="<img src=picture/product/3741aae820b947709a06000c4e06a47e.gif"/r/gou/www/images/product/c_b_1.jpg\" />";
...
<div class="caseImg03 ctr clearfix">
        ...
        <div class="bd03">
			     ...
			     <div class="c3">
	                <a class="grid one-grid small" href="/riyongbaihuo/40.htm">
	                    ...
	                    <img src="picture/product/09110022apad.jpg">
						</img>
	                </a>
	                
	                <div class="hidden">
	                 <a href="/riyongbaihuo/40.htm">  <img src="picture/product/09110103o39o.jpg"/>  </a>         
	                </div>
			     ...
			     <div class="c3">
	                <a class="grid one-grid small" href="/woman/35.htm">
	                    ...
	                    <img src="picture/product/08133609vw7k.jpg">
						</img>
	                </a>
	                
	                <div class="hidden">
	                 <a href="/woman/35.htm">  <img src="picture/product/08133627vekx.jpg"/>  </a>         
	                </div>
			     ...
			     <div class="c3">
	                <a class="grid one-grid small" href="/nvxie/34.htm">
	                    ...
	                    <img src="picture/product/08133422q64n.jpg">
						</img>
	                </a>
	                
	                <div class="hidden">
	                 <a href="/nvxie/34.htm">  <img src="picture/product/08134513tbrl.jpg"/>  </a>         
	                </div>
			     ...
			     <div class="c3">
	                <a class="grid one-grid small" href="/riyongbaihuo/33.htm">
	                    ...
	                    <img src="picture/product/081332452i71.jpg">
						</img>
	                </a>
	                
	                <div class="hidden">
	                 <a href="/riyongbaihuo/33.htm">  <img src="picture/product/081344040ef9.jpg"/>  </a>         
	                </div>
			     ...
			     <div class="c3">
	                <a class="grid one-grid small" href="/riyongbaihuo/32.htm">
	                    ...
	                    <img src="picture/product/08133139vwiz.jpg">
						</img>
	                </a>
	                
	                <div class="hidden">
	                 <a href="/riyongbaihuo/32.htm">  <img src="picture/product/081331570f2z.jpg"/>  </a>         
	                </div>
			     ...
			     <div class="c3">
	                <a class="grid one-grid small" href="/riyongbaihuo/31.htm">
	                    ...
	                    <img src="picture/product/08133008d6xt.jpg">
						</img>
	                </a>
	                
	                <div class="hidden">
	                 <a href="/riyongbaihuo/31.htm">  <img src="picture/product/0813433503xr.jpg"/>  </a>         
	                </div>
			     ...
			     <div class="c3">
	                <a class="grid one-grid small" href="/bg/30.htm">
	                    ...
	                    <img src="picture/product/08132857pwgx.jpg">
						</img>
	                </a>
	                
	                <div class="hidden">
	                 <a href="/bg/30.htm">  <img src="picture/product/081329281jw2.jpg"/>  </a>         
	                </div>
			     ...
			     <div class="c3">
	                <a class="grid one-grid small" href="/woman/29.htm">
	                    ...
	                    <img src="picture/product/08132728cc4o.jpg">
						</img>
	                </a>
	                
	                <div class="hidden">
	                 <a href="/woman/29.htm">  <img src="picture/product/08132744djsq.jpg"/>  </a>         
	                </div>
			     ...
			     <div class="c3">
	                <a class="grid one-grid small" href="/nanbao/27.htm">
	                    ...
	                    <img src="picture/product/081323138k7f.jpg">
						</img>
	                </a>
	                
	                <div class="hidden">
	                 <a href="/nanbao/27.htm">  <img src="picture/product/081322476p6l.jpg"/>  </a>         
	                </div>
    ...
    <div class="caselayBox">
		<div class="casehtml">
			<img src="${pageContext.request.contextPath}/picture/product/081329281jw2_1.jpg" alt="离家出走了" width="100%"/>
		</div>
	</div>
</div>
		...
		<div class="floor-line-con color-type-blue">
			...
			<div class="line-body">
				...
				<div class="left-column-con blueBg">
					...
					<img src="picture/product/left-column-con-blue-pic.jpg"
						width="190" />
				...
				<div class="big-banner-con">
					...
					<div class="jiaodiantu1">
						<!--<ul class="buypic">
							<li><a href=""><img src="picture/product/f1.jpg" /></a></li>
							<li><a href=""><img src="picture/product/f1c.jpg" /></a></li>
							<li><a href=""><img src="picture/product/f1b.jpg" /></a></li>
						</ul>-->

				           
						<ul class="buypic">
							   <li><a href="/shouji/index.htm"><img src="picture/product/f1b.jpg" /></a></li>
							    <li><a href="/bjb/index.htm"><img src="picture/product/f1.jpg" /></a></li>
							   <li><a href="/xj/index.htm"><img src="picture/product/f1c.jpg" /></a></li>
						</ul>
				...
				<div class="right-column-con">
			          	       <a class="grid one-grid"  href="/sanxing/59.htm">
									 ...
									 <img
									src="picture/product/02161238e7wo.jpg">
									</img>
			          	       ...
			          	       <a class="grid one-grid"  href="/bg/16.htm">
						          	<div class="title">虚拟现实3d眼镜
									    ...
									    <div class="sub-title">联合营销</div>
									 <img
									src="picture/product/061626478mo5.jpg">
									</img>
			          	       ...
			          	       <a class="grid one-grid"  href="/tsj/15.htm">
						          	<div class="title">Edifier/漫步者
									    ...
									    <div class="sub-title">联合营销</div>
									 <img
									src="picture/product/061625384z8h.jpg">
									</img>
			          	       ...
			          	       <a class="grid one-grid"  href="/bjb/14.htm">
						          	<div class="title">Asus/华硕 FX
									    ...
									    <div class="sub-title">联合营销</div>
									 <img
									src="picture/product/06162402vno3.jpg">
									</img>
			          	       ...
			          	       <a class="grid one-grid"  href="/xj/13.htm">
						          	<div class="title">天猫魔盒3Pro
									    ...
									    <div class="sub-title">联合营销</div>
									 <img
									src="picture/product/06162301f2zj.jpg">
									</img>
			          	       ...
			          	       <a class="grid one-grid"  href="/Iphone/12.htm">
						          	<div class="title">小米手环2蓝牙
									    ...
									    <div class="sub-title">联合营销</div>
									 <img
									src="picture/product/0616183833km.jpg">
									</img>
		...
		<div class="floor-line-con color-type-pink">
			...
			<div class="line-body">
				...
				<div class="left-column-con pinkBg">
					...
					<img src="picture/product/left-column-con-pink-pic.jpg"
						width="190" />
					<div class="keyword-list">
...
衣柜</a>
				...
				<div class="big-banner-con">
					<div class="jiaodiantu2">
						<!--<ul class="buypic">
							<li><a href=""><img src="picture/product/f2.jpg" /></a></li>
							<li><a href=""><img src="picture/product/f2b.jpg" /></a></li>
							<li><a href=""><img src="picture/product/f2.jpg" /></a></li>
						</ul>-->
						...
						<ul class="buypic">
							    <li><a href="/woman/index.htm"><img src="picture/product/f2.jpg" /></a></li>
							   <li><a href="/man/index.htm"><img src="picture/product/f2b.jpg" /></a></li>
							   <li><a href="/neiyi/index.htm"><img src="picture/product/f2c.jpg" /></a></li>
						</ul>
				...
				<div class="right-column-con">
			          	     <a class="grid one-grid"  href="/woman/37.htm">
						          	<div class="title">牛仔裤
									    ...
									    <div class="sub-title">联合营销</div>
									 <img
									src="picture/product/09110440ls2s.jpg">
									</img>
			          	     ...
			          	     <a class="grid one-grid"  href="/woman/22.htm">
						          	<div class="title">茵曼内衣
									    ...
									    <div class="sub-title">联合营销</div>
									 <img
									src="picture/product/06171019ezrz.jpg">
									</img>
			          	     ...
			          	     <a class="grid one-grid"  href="/woman/21.htm">
						          	<div class="title">派克外套
									    ...
									    <div class="sub-title">联合营销</div>
									 <img
									src="picture/product/06170852f8wr.jpg">
									</img>
			          	     ...
			          	     <a class="grid one-grid"  href="/woman/20.htm">
						          	<div class="title">蝴蝶结饰牛仔夹克
									    ...
									    <div class="sub-title">联合营销</div>
									 <img
									src="picture/product/06170735f214.jpg">
									</img>
			          	     ...
			          	     <a class="grid one-grid"  href="/man/19.htm">
						          	<div class="title">青年外衣棒球服
									    ...
									    <div class="sub-title">联合营销</div>
									 <img
									src="picture/product/06170631wgix.jpg">
									</img>
			          	     ...
			          	     <a class="grid one-grid"  href="/man/18.htm">
						          	<div class="title">男长袖白衬衫
									    ...
									    <div class="sub-title">联合营销</div>
									 <img
									src="picture/product/06170500mfam.jpg">
									</img>
 ...
 <!-- 
		...
		<div class="floor-line-con color-type-green">
			...
			<i class="color-mark"></i>
			<div class="floor-name">鞋包配饰</div>
			<div class="line-body">
				<div class="hot-word-con">
			          	 <a href="/nvbao/index.htm" class="hot-word">女包</a>
			          	 <a href="/nanxie/index.htm" class="hot-word">男鞋</a>
			          	 <a href="/tongxie/index.htm" class="hot-word">童鞋</a>
			          	 <a href="/nvxie/index.htm" class="hot-word">女鞋</a>
			          	 <a href="/nanbao/index.htm" class="hot-word">男包</a>
				</div>
				<div class="left-column-con greenBg">
					<div class="title">卧室个性巧搭</div>
					<div class="sub-title">懂你 懂生活</div>
					<div class="bg-title">2件8折优惠</div>
					<img src="picture/product/left-column-con-green-pic.jpg"
						width="190" />
					<div class="keyword-list">
						<a href="hotword" class="hotword fl">餐桌</a> <a href="hotword"
							class="hotword fl">枕头</a> <a href="hotword" class="hotword fl">客
...
衣柜</a>
				...
				<div class="big-banner-con">
					<div class="jiaodiantu3">
						<ul class="buypic">
							<li><a href=""><img src="picture/product/f3.jpg" /></a></li>
							<li><a href=""><img src="picture/product/f3.jpg" /></a></li>
							<li><a href=""><img src="picture/product/f3.jpg" /></a></li>
						</ul>
						<a class="prev" href="javascript:void(0)"></a> <a class="next"
				...
				<div class="right-column-con">
			          	      <a class="grid one-grid"  href="/banxie/52.htm">
						          	<div class="title">阿迪达斯adidas男

</div>
									    <div class="sub-title">联合营销</div>
									 <img
									src="picture/product/10131853kztz.jpg">
									</img>
									
						         </a>
			          	      <a class="grid one-grid"  href="/nvxie/34.htm">
						          	<div class="title">春季新品发布会

</div>
									    <div class="sub-title">联合营销</div>
									 <img
									src="picture/product/08133422q64n.jpg">
									</img>
									
						         </a>
			          	      <a class="grid one-grid"  href="/nanbao/27.htm">
						          	<div class="title">源自法国头皮 牛包

</div>
									    <div class="sub-title">联合营销</div>
									 <img
									src="picture/product/081323138k7f.jpg">
									</img>
  ...
  <!---------------3end---------------------->
   ...
   <!--------------4start---------------------->
	 	...
	 	<div class="floor-line-con color-type-green">
			...
			<i class="color-mark"></i>
			<div class="floor-name">日用百货</div>
			<div class="line-body">
				<div class="hot-word-con">
			          	 <a href="/shenghuodianqi/index.htm" class="hot-word">生活电器</a>
				</div>
				<div class="left-column-con greenBg">
					<div class="title">卧室个性巧搭</div>
					<div class="sub-title">懂你 懂生活</div>
...
衣柜</a>
				...
				<div class="big-banner-con">
					<div class="jiaodiantu3">
						<!--<ul class="buypic">
							<li><a href=""><img src="picture/product/f3.jpg" /></a></li>
							<li><a href=""><img src="picture/product/f3c.jpg" /></a></li>
							<li><a href=""><img src="picture/product/f3.jpg" /></a></li>
						</ul>-->


						<ul class="buypic">
							   <li><a href="/wujingongju/index.htm"><img src="picture/product/f3c.jpg" /></a></li>
							    <li><a href="/woshijiaj/index.htm"><img src="picture/product/f3.jpg" /></a></li>
						</ul>   
				...
				<div class="right-column-con">
			          	      <a class="grid one-grid"  href="/wujingongju/39.htm">
						          	<div class="title">不锈钢三角支架承
									    ...
									    <div class="sub-title">联合营销</div>
									 <img
									src="picture/product/130946189262.jpg">
									</img>
			          	      ...
			          	      <a class="grid one-grid"  href="/woshijiaj/36.htm">
						          	<div class="title">天然乳胶床垫席梦
									    ...
									    <div class="sub-title">联合营销</div>
									 <img
									src="picture/product/091056187tib.jpg">
									</img>
			          	      ...
			          	      <a class="grid one-grid"  href="/woshijiaj/28.htm">
						          	<div class="title">伊甸嘉园真皮沙发
									    ...
									    <div class="sub-title">联合营销</div>
									 <img
									src="picture/product/13095401tlfm.jpg">
									</img>
			          	      ...
			          	      <a class="grid one-grid"  href="/woshijiaj/26.htm">
						          	<div class="title">护腰靠垫办公室腰
									    ...
									    <div class="sub-title">联合营销</div>
									 <img
									src="picture/product/06172100h4h8.jpg">
									</img>
			          	      ...
			          	      <a class="grid one-grid"  href="/woshijiaj/25.htm">
						          	<div class="title">推拉门衣柜 推拉
									    ...
									    <div class="sub-title">联合营销</div>
									 <img
									src="picture/product/13102848c957.jpg">
									</img>
			          	      ...
			          	      <a class="grid one-grid"  href="/woshijiaj/24.htm">
						          	<div class="title">后现代时尚个性铜
									    ...
									    <div class="sub-title">联合营销</div>
									 <img
									src="picture/product/1310173552gr.jpg">
									</img>
 ...
 <!--------------6start---------------------->
		...
		<div class="floor-line-con color-type-green">
			...
			<i class="color-mark"></i>
			<div class="floor-name">珠宝手表</div>
			<div class="line-body">
				<div class="hot-word-con">
			          	 <a href="/huangjinshoushi/index.htm" class="hot-word">黄金首饰</a>
			          	 <a href="/zuanshi/index.htm" class="hot-word">钻石彩宝</a>
			          	 <a href="/wanbiao/index.htm" class="hot-word">腕表</a>
				</div>
				<div class="left-column-con greenBg">
					<div class="title">卧室个性巧搭</div>
					<div class="sub-title">懂你 懂生活</div>
		...
		<div class="wonderful-con">
			<ul style="display: block">
			          	    ...
			          	    <li>  <a href="/kongtiao/56.htm">
			          	             <img src="picture/product/10132243iug1.jpg">
			          	    ...
			          	    <li>  <a href="/pingbandianshi/55.htm">
			          	             <img src="picture/product/10132132cm7d.jpg">
			          	    ...
			          	    <li>  <a href="/jiehunzuanjie/54.htm">
			          	             <img src="picture/product/10132034y3zr.jpg">
			          	    ...
			          	    <li>  <a href="/ipad/53.htm">
			          	             <img src="picture/product/10131953rujl.jpg">
			          	    ...
			          	    <li>  <a href="/banxie/52.htm">
			          	             <img src="picture/product/10131853kztz.jpg">
			          	    ...
			          	    <li>  <a href="/ruishimingbiao/51.htm">
			          	             <img src="picture/product/101317544ckb.jpg">
...
<!--
				<li><a href=""> <img src="picture/product/w1.jpg">
...
挂式空调
        ...
        <li><a href=""> <img src="picture/product/w2.jpg">
                    <p class="guess_title">海尔彩电LE32G310G 32英寸高清LED液晶电视</p>
                    <p class="guess_price">
                        <span class="yuan">￥</span>1299.00
                    </p></a></li>
        <li><a href=""> <img src="picture/product/w3.jpg">
                    <p class="guess_title">梦克拉白18K金钻石戒指 缘美 女戒指</p>
                    <p class="guess_price">
                        <span class="yuan">￥</span>11999.00
                    </p></a></li>
        <li><a href=""> <img src="picture/product/w4.jpg">
                    <p class="guess_title">Apple iPad Air 2 平板电脑（32G金色
                        WiFi版）MNV72CH/A</p>
                    <p class="guess_price">
                        <span class="yuan">￥</span>39.90
                    </p></a></li>
        <li><a href=""> <img src="picture/product/w5.jpg">
...
43)</p>
        ...
        <li><a href=""> <img src="picture/product/w6.jpg">
...
<div class="Footer">
    ...
    <div class="Footer-block pt20 pb20 ctr cf">
        ...
        <div class="QR fl">
            <img class="QR-img" src="picture/product/jspgou-wx.jpg" >
        </div>
    </div>
	<!-- 帮助中心栏目 end-->
